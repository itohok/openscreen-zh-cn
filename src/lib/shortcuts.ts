...
export const FIXED_SHORTCUTS: FixedShortcut[] = [
	{ labelKey: "undo", display: "Ctrl + Z", bindings: [{ key: "z", ctrl: true }] },
	{
		labelKey: "redo",
	...
	{ labelKey: "cycleAnnotationsForward", display: "Tab", bindings: [{ key: "tab" }] },
	{
		labelKey: "cycleAnnotationsBackward",
		display: "Shift + Tab",
		bindings: [{ key: "tab", shift: true }],
	},
	{
		labelKey: "deleteSelectedAlt",
		display: "Del / ⌫",
		bindings: [{ key: "delete" }, { key: "backspace" }],
	},
	{ labelKey: "panTimeline", display: "Shift + Ctrl + Scroll", bindings: [] },
	{ labelKey: "zoomTimeline", display: "Ctrl + Scroll", bindings: [] },
];

export type ShortcutConflict =
	| { type: "configurable"; action: ShortcutAction }
	| { type: "fixed"; labelKey: FixedShortcut["labelKey"] };
